...
namespace myoBlog29API.Controllers
{
    ...
    public class ServisController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/cevapliste/{makaleId}")]
        public List<CevapModel> CevapListe(int makaleId)
        {
            List<CevapModel> liste = db.Cevap.Where(s => s.MakaleId == makaleId).Select(x => new CevapModel()
            {
                MakaleId = x.MakaleId,
                Cevap1 = x.Cevap1,
                UyeId = (int)x.UyeId,
